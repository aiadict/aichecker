          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  No meaningful AI involvement detected in this stretch. Left unhighlighted (plain
                  text) in the highlighted text view, specifically so the parts that{" "}
                  <em>are</em> flagged stand out clearly against everything that isn&apos;t.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  extend it, or an AI draft that was substantially hand-edited afterward - the
                  boundary between the two gets blurry enough that it&apos;s not confidently one
                  or the other. Shown in yellow in the highlighted text view.
                </td>
              </tr>
              <tr>
                <td><span className="pill ai">AI</span></td>
                <td>
                  Reads as generated by an AI model with no meaningful human authorship. Shown in
                  red in the highlighted text view.
                </td>
              </tr>
            </tbody>
          </table>
